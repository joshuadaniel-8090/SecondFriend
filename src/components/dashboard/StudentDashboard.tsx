...
import { BookOpen, HeartPulse, MessageSquare, MoreHorizontal, PlusCircle, Users } from 'lucide-react';
        ...
        <div className="space-y-8">
          {sessions.length === 0 ? (
            ...
            <>
              ...
              <SessionSection title="Pending Requests" sessions={pendingSessions} router={router} />
...
function SessionSection({ title, sessions, router }: { title: string, sessions: Session[], router: any }) {
